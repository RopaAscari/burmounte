...
import FeatureIllustration from "@/assets/images/features-illustration.png";
import CarouselIllustration from "@/assets/images/carousel-illustration-01.jpg";
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                ...
                <p className="text-lg text-zinc-500">
                  Gray can understand what you are designing, learn from your feedback to take your creativity further, and turn it instantly into beautiful
                  images.
                </p>
              </div>
              {/* Tabs buttons */}
