...
import ModelDisplay from "./model";
...
export default function Hero() {
  ...
  return (
    <section className="dark:bg-black relative before:absolute before:inset-0 before:h-80 before:pointer-events-none before:bg-gradient-to-b before:from-zinc-100 before:-z-10">
      <div className="lg:pt-32 pb-12 md:pt-40 md:pb-20">
        {/* Section content */}
        <div className="px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center ">
              <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text dark:text-white text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">
                The predictive{" "}
                <em className="italic relative dark:text-white inline-flex justify-center items-center text-zinc-900">
                  {" "}
                  platform
                  <svg
                    className="absolute dark:fill-white fill-zinc-300 w-[calc(100%+1rem)] -z-10"
                ...
                for enhanced financial insights
              </h1>
              <p className="text-lg text-zinc-500 dark:text-white mb-10">
                Turbocharge your financial predictions with alphatrader, your AI model for predictive pricing on financial instruments.
              </p>
              <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <div>
                  <Link onClick={openSubscription} className="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow" href="/onboarding">
                    Get Started
                  </Link>
                </div>
                <div>
        ...
        {/* Image */}
        <div className="lg:py-0 py-10 max-w-6xl mx-auto px-4 sm:px-6 flex justify-center relative ">
