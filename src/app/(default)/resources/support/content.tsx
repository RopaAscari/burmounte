...
import DocsImage01 from "@/assets/images/docs-image-01.png";
import DocsImage02 from "@/assets/images/docs-image-02.png";

export default function DocumentationContent() {
  return (
    <div className="md:grow">
      <div className="text-lg text-gray-600">
        <h2 className="h2 text-gray-900 mb-4">Introduction to Burmounte</h2>
        <p className="mb-8">
          Welcome to Burmounte, your trusted trading platform for seamless and profitable trading experiences. At Burmounte, we are committed to providing you
          with the tools and resources you need to excel in the world of trading. Our platform is designed to empower both novice and experienced traders,
          offering a wide range of features and services to enhance your trading journey. Whether you're interested in stocks, cryptocurrencies, forex, or
          commodities, Burmounte has you covered.
        </p>

        <h3 id="quick" className="h3 text-gray-900 mb-8" style={{ scrollMarginTop: "100px" }}>
          Quick Start
        </h3>

        <p className="mb-8">To begin your trading journey with Burmounte, you have two convenient options:</p>

        <ol className="mb-8 list-decimal list-inside text-gray-900 space-y-5">
          <li>Download the Burmounte app from your preferred app store, whether it's the Play Store for Android or the App Store for iOS.</li>
          <li>
            Click "Get Started" to create your trading account with Deriv, our trusted partner. Burmounte has teamed up with Deriv to provide you with a
            seamless and secure trading experience.
          </li>
        </ol>

        <p className="mb-8">
          Once you've taken one of these steps, you'll be on your way to customizing your trading settings and exploring the exciting world of financial
          markets.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        >
          <div>
            <div className="text-normal font-medium mb-1">Business Affliate Program</div>
            <div className="text-sm text-gray-600">Learn more about our affiliate program.</div>
          </div>
        ...
        >
          <div>
            <div className="text-normal font-medium mb-1">Alpha Trader</div>
            <div className="text-sm text-gray-600">Learn more about our AI powered predicitive model.</div>
          </div>
          <svg className="w-4 h-4 fill-current text-blue-600 shrink-0 ml-6" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.3 14.7l-1.4-1.4L12.2 9H0V7h12.2L7.9 2.7l1.4-1.4L16 8z" />
          </svg>
