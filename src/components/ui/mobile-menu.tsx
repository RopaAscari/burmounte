  ...
  return (
    <div className="inline-flex md:hidden">
      ...
      >
        ...
        <svg
          className="w-6 h-6 fill-current text-gray-200 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 transition duration-150 ease-in-out"
          viewBox="0 0 24 24"
            ...
            <ul>
              {navRoutes.map((route, index) =>
                route.children.length > 0 ? (
                  <li key={index} className="py-2 my-2 border-t border-b border-gray-200 dark:border-gray-800">
                    <span className="flex text-gray-600 dark:text-gray-400 py-2">{route.title}</span>
                    <ul className="pl-4">
