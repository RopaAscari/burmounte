...
import RelatedImage03 from "@/assets/images/related-post-03.jpg";
import RelatedImage04 from "@/assets/images/related-post-04.jpg";
import RelatedImage05 from "@/assets/images/related-post-05.jpg";
          ...
          <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4" data-aos-id-featposts>
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <a className="hover:underline" href="#0">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">Creating events in the pandemic</h3>
                  </a>
                </header>
                <footer>
            ...
            <article className="relative group px-6 py-4 sm:py-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-featposts]" data-aos-delay="200">
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <a className="hover:underline" href="#0">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">5 Ways to grow your personal network</h3>
                  </a>
                </header>
                <footer>
            ...
            <article className="relative group px-6 py-4 sm:py-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-featposts]" data-aos-delay="300">
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <a className="hover:underline" href="#0">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">How to fix my website myself</h3>
                  </a>
                </header>
                <footer>
            ...
            <article className="relative group px-6 py-4 sm:py-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-featposts]" data-aos-delay="400">
              ...
              <div className="relative flex flex-col h-full text-white">
                <header className="grow">
                  <a className="hover:underline" href="#0">
                    <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">How COVID-19 redefined the entrepreneur</h3>
                  </a>
                </header>
                <footer>
