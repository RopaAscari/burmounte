...
import RelatedImage01 from "@/assets/images/related-post-01.jpg";
import RelatedImage02 from "@/assets/images/related-post-02.jpg";
import Author01 from "@/assets/images/news-author-04.jpg";
import Author02 from "@/assets/images/news-author-03.jpg";
            ...
            <div className="grid gap-4 sm:gap-6 sm:grid-cols-2" data-aos-id-relposts>
                ...
                <div className="relative flex flex-col h-full">
                  <header className="grow">
                    <a className="hover:underline" href="#0">
                      <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">How to talk about yourself in the best possible way</h3>
                    </a>
              ...
              <article className="relative group p-6 text-white" data-aos="fade-down" data-aos-anchor="[data-aos-id-relposts]" data-aos-delay="200">
                ...
                <div className="relative flex flex-col h-full">
                  <header className="grow">
                    <a className="hover:underline" href="#0">
                      <h3 className="text-lg font-red-hat-display font-bold tracking-tight mb-2">How I Park Inc make $5,000 every month by sellings gifts</h3>
                    </a>
