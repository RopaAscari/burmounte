...
import MeixcoFlag from "@/assets/images/mexico.png";
import PlanetImage from "@/assets/images/planet.png";
import JamaicaFlag from "@/assets/images/jamaica.webp";
import ArgentinaFlag from "@/assets/images/argentina.png";

export default function FeatureGlobe() {
  return (
    <section className="relative border-t border-transparent dark:border-gray-800 pb-24">
      {/* Background gradient */}
      <div
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 font-red-hat-display mb-4">We offer trading solutions to individuals across Latin America.</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Our trading platform enables you to trade in 103 countries across the globe, providing a truly international trading experience.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center pt-12 md:pt-16">
            <div className="relative">
              ...
              {/* Avatars */}
              <Image className="absolute max-w-full transform animate-float" src={ArgentinaFlag} alt="" style={{ width: "12%", top: "-3%", right: "20%" }} />
              ...
              <Image
                ...
                style={{ width: "12%", bottom: "20%", left: "30%" }}
              />
              ...
              <Image
                ...
                height={173}
                alt="Planet avatar 02"
                style={{ width: "12%", bottom: "70%", left: "60%" }}
              />
              ...
              <Image
                ...
                height={173}
                alt="Planet avatar 02"
                style={{ width: "12%", bottom: "10%", left: "70%" }}
              />
