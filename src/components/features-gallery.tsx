...
import AboutImage01 from "@/assets/images/about-grid-01.jpg";
import AboutImage02 from "@/assets/images/about-grid-02.jpg";
import AboutImage03 from "@/assets/images/about-grid-03.jpg";
import AboutImage04 from "@/assets/images/about-grid-04.jpg";
import AboutImage05 from "@/assets/images/about-grid-05.jpg";
import AboutImage06 from "@/assets/images/about-grid-06.jpg";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-6xl mx-auto  pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4 text-center">We help people acheive financial success</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              In line with our mission at Burmonte, we are proud to be a prominent global online brokerage platform. We provide a wide range of financial
              instruments, including CFDs and derivatives on forex, stocks & indices, cryptocurrencies, commodities, and derived indices, to a vast community of
              registered users worldwide.
              <br></br> <br></br>
              From the very beginning, our vision has been to revolutionize the financial industry by offering competitive pricing and cutting-edge products,
              distinguishing us from traditional brokers. Moreover, our commitment is to offer an exceptional trading experience to traders who prefer a digital
              approach, irrespective of the scale of their investments.
            </p>
          </div>
          ...
          {/* <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-4 items-start md:max-w-5xl">
            <div className="relative flex flex-col items-center">
              <div
                ...
                style={{ width: "calc(100% - 96px)", left: "calc(50% + 64px)", top: "40px" }}
              ></div>
          ...
          {/* Images grid */}
          <div className="grid grid-cols-12 gap-3 mt-6" data-aos-id-gallery>
            <Image
